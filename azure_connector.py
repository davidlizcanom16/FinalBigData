...
class AzureCosmosConnector:
    ...
    def subir_datos_desde_json(self, archivo_json='datos_ecommerce.json'):
        ...
        try:
            ...
            for snapshot in datos:
                ...
                # Insertar productos de este snapshot
                for producto in productos:
                    # Agregar metadata del snapshot
    ...
    def limpiar_coleccion(self):
        """Elimina todos los documentos de la colección (útil para pruebas)"""
        try:
...
if __name__ == "__main__":
    ...
    if connector.conectar():
        ...
        # Subir datos desde el archivo JSON
